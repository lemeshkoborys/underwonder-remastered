    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, help_text='Для какой категории данная будет родительской', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='main_menu.MenuCategory', verbose_name='Родительская категория')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main_menu.MenuCategory', verbose_name='Категория')),
            ],
            options={
